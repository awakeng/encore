...
public class APITest {
	...
	public static void main(String[] args) {
		...
		String v = "삼";
		System.out.println(Integer.parseInt(v));	// 컴파일러 오류는 안 뜨지만 실행오류가 뜨는 경우
...
syso(String.charAt(9));		-> 어떤 문자 변수의 index번째 음절을 반환해야하는지 모르기 때문에 static을 붙이면 안된다.
